  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-4 grid grid-cols-2 md:grid-cols-6 gap-3">
        {[
          { k: 'Total models', v: stats.total, s: `v${dataMeta.data_version ?? '2026-09-23'} · CSV 1-${stats.total ?? 0} · refreshed ${dataMeta.data_regen_at ?? DATA_AS_OF} · fact-checked ${VERIFIED_AT}`, icon: Database },
