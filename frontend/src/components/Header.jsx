      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-white/60 hidden sm:block">{stats.total} models (CSV ranks 1-267 single source of truth) · Online re-verified {VERIFIED_AT} · ₹95.12/USD · Private / local-first</p>
          </div>
        </div>
